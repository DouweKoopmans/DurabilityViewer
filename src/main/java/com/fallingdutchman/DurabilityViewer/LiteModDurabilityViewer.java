...
public class LiteModDurabilityViewer implements LiteMod, Configurable, HUDRenderListener
{
    ...
    public void onPostRenderHUD(int screenWidth, int screenHeight)
    {
        ...
        if ((this.mc.inGameHasFocus || mc.currentScreen == null || mc.currentScreen instanceof GuiChat)
                && instance.RADur && !(instance.ArmourLoc == 0 && this.mc.gameSettings.keyBindPlayerList.isKeyDown()
