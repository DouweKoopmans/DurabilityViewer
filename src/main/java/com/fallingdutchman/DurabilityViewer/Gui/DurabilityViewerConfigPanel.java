...
public class DurabilityViewerConfigPanel extends Gui implements ConfigPanel
{
    ...
    private GuiRadioHandler ContDurModeRadioController, ArmourDurModeRadioController, DurSizeRadioController, ArmourLocRadioController;
    ...
    public void onPanelShown(ConfigPanelHost host) //TODO: add support for .lang files
    {
        ...
        ArmourLocRadioController = new GuiRadioHandler(this.mc, this.fr, ArmourLocModes, id++, RANK_TWO, line++, "Where to draw the armour HUD", LiteModDurabilityViewer.instance.ArmourLoc, LiteModDurabilityViewer.instance.RADur);
        ...
        GuiButtons.addAll(ArmourLocRadioController.getButtons());
    ...
    public void onPanelHidden()
    {
        ...
        LiteModDurabilityViewer.instance.ArmourLoc = ArmourLocRadioController.getSettings();
    ...
    public void drawPanel(ConfigPanelHost host, int mouseX, int mouseY, float partialTicks)
    {
        ...
        ArmourLocRadioController.Draw(mouseX, mouseY);
            ...
            if (button instanceof GuiButton)
            {
                ...
                if (_button.mousePressed(this.mc, mouseX, mouseY))
                {
                    ...
                    } else if (button instanceof GuiRadioButton)
                    {
                        ...
                        } else if (ArmourLocRadioController.getButtons().contains(button))
                        {
                            ArmourLocRadioController.mousePressed((GuiRadioButton) button);
                        }
                    ...
                    } else if (button.equals(ArmourDurStringBox))
                    {
                        ...
                        ArmourLocRadioController.Refresh(LiteModDurabilityViewer.instance.RADur);
